...
public class SimulationView extends JPanel{
	...
	static private SimulationView simulationView;
	
	static public SimulationView getSimulationView(){
		if (simulationView == null){
			simulationView = new SimulationView(numFloors, numElevators, numComponents);
		}
		return simulationView;
	}
	
	private SimulationView(int numFloors, int numElevators, int numComponents){
	...
	static public void init(int numFloors, int numElevators){
		SimulationView.numFloors = numFloors;
		SimulationView.numElevators = numElevators;
		SimulationView.numComponents = numComponents;
	}
